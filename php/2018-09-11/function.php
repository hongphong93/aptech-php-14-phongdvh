...
<tbody> -->
<?php
// function displayName ($ten,$tuoi) {
// echo "$ten";
// echo " $tuoi" . " tuoi <br>";
// };
// displayName('Phong','25');
// displayName("Huan",'24');
...
// $dslop = array('Phong', 'Huan', 'Phong', 'Thai', 'Vuong', 'Dat');
// $STT = count($dslop);
// for ($x = 0; $x < $STT; $x++){
// echo $x + 1;
// echo " => " . $dslop[$x];
...
// $mobile = ["iPhone"=> 999, "Samsung" => 888, "Oppo" => 555];
// foreach ($mobile as $x => $gia){
// echo 'Dien thoai <strong>' . $x . '</strong> co gia la <strong>' . $gia . " $ </strong><br>";
// };
...
//     echo "<tr><td>$value[id]</td><td>$value[name]</td><td>$value[email]</td><td>$value[password]</td></tr>";
// };
$arr = [
    "id" => 4469,
